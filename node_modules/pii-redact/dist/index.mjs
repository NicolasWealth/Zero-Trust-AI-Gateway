...
var Redactor = class {
   ...
   */
  redactObject(obj, options, currentKey) {
    ...
    if (typeof obj === "string") {
      if (options?.keysToRedact) {
        ...
        if (redacted === obj && currentKey) {
          return this.defaultStrategy.apply(obj, currentKey.toUpperCase());
        }
        return redacted;
      }
    ...
    if (Array.isArray(obj)) {
      return obj.map((item) => this.redactObject(item, options, currentKey));
    }
